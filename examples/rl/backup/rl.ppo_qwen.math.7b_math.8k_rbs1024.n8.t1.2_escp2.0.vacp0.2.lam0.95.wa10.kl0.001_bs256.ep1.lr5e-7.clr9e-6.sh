...
TRIAL_NAME="rl.ppo_qwen.math.7b_${DATASET_NAME}_.rbs${ROLLOUT_BS}.n${N_SAMPLES_PER_PROMPT}.t${TEMPERATURE//.}_escp${EPS_CLIP}.vacp${VALUE_CLIP}.lam${LAMBDA}.wa${WARMUP}.kl${KL_COEF//.}\_bs${BS}.ep${EP}.lr${LR}.clr${CLR}"
