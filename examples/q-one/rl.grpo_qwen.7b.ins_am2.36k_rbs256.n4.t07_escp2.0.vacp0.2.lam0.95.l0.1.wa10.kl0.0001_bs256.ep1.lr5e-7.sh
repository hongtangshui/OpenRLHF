...
TRIAL_NAME="rl.grpo_qwen.7b.ins_${DATASET_NAME}_rbs${ROLLOUT_BS}.n${N_SAMPLES_PER_PROMPT}.t${TEMPERATURE//.}_escp${EPS_CLIP}.vacp${VALUE_CLIP}.lam${LAMBDA}.l${L2}.wa${WARMUP}.kl${KL_COEF//.}\_bs${BS}.ep${EP}.lr${LR}"
