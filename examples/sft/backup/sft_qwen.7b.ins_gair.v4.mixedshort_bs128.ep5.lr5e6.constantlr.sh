...
DATA_NAME=gair.v4.mixedshort
BS=128
EP=5
LR=5e-6
LR_SCHEDULER=constant

TRIAL_NAME=sft_qwen.7b.ins_${DATA_NAME}_bs${BS}.ep${EP}.lr${LR}.constantlr


MODEL_PATH=/mnt/bn/seedllm3-lixuefeng-3/ckpts/Qwen/Qwen2.5-7B-Instruct
