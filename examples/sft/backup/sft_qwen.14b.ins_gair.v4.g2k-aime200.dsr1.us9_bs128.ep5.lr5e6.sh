...
DATA_NAME=gair.v4.g2k-aime200.dsr1.us9
BS=128
EP=5
LR=5e-6
LR_SCHEDULER=cosine_with_min_lr

TRIAL_NAME=sft_qwen.14b.ins_${DATA_NAME}_bs${BS}.ep${EP}.lr${LR}


MODEL_PATH=/mnt/bn/seedllm3-lixuefeng-3/ckpts/Qwen/Qwen2.5-14B-Instruct
