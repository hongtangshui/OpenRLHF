...
DATA_NAME=gair.v4.mixedlong
BS=128
EP=5
LR=5e-6
LR_SCHEDULER=cosine_with_min_lr

TRIAL_NAME=sft_qwen.7b.ins.stage1.v1_${DATA_NAME}_bs${BS}.ep${EP}.lr${LR}


MODEL_PATH=/mnt/bn/seedllm3-lixuefeng-3/ckpts/openrlhf/sft/sft_qwen.7b.ins_gair.v4.mixedshort_bs128.ep5.lr5e-6.constantlr/
