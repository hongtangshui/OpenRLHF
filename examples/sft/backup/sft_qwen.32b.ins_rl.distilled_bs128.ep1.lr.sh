...
DATA_NAME=aime.rldistilled
BS=32
EP=5
LR=1e-5
LR_SCHEDULER=cosine_with_min_lr

TRIAL_NAME=sft_qwen.32b.ins_${DATA_NAME}_bs${BS}.ep${EP}.lr${LR}


MODEL_PATH=/mnt/bn/seedllm3-lixuefeng-3/ckpts/Qwen/Qwen2.5-32B-Instruct
